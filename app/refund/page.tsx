export const metadata = {
  title: "Refund Policy — Songee",
  description: "Songee's cancellation, refund, and revision policy for custom songs.",
};
      ...
      <section className="legal-page">
        <div className="container">
          ...
          <div className="legal-body">
            <p>At Songee, all songs are custom-made digital products created specifically for each customer. Because of the personalized nature of the service, our cancellation, refund, and revision policies are limited.</p>
            ...
            <p>If Songee fails to deliver a product substantially as described due solely to an error on our side, we may choose to correct and re-deliver the product, or issue a partial or full refund at our discretion.</p>
